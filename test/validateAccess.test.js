...
describe("Validate Access", () => {
  describe("Just entry", () => {
    ...
    it.only("Entry with entry dir without extension", () => {
    ...
    it.only("Entry with entry dir and extension", () => {
    ...
    it.only("Invalid entry with entry dir and extension", () => {
    ...
    it.only("Entry with invalid entry dir and extension", () => {
  ...
  describe("Just directory", () => {
    it("Directory with no valid files and folders", () => {
